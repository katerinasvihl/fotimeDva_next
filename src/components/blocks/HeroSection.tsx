...
export const HeroSection = ({
  ...
  return (
    <div className="relative h-[90vh] w-full wide:h-[100vh] tall:h-[100vh] short:h-[100vh]">
      <StrapiImage
      ...
      <div className="container relative z-10 mx-auto flex h-full w-full px-3 md:max-w-[700px] md:px-0 lg:max-w-[900px] xl:max-w-[1200px]">
        <div className="flex h-full flex-col justify-end pb-[70px] font-heading lg:pb-[180px]">
          <h1 className="mb-3 max-w-[600px] text-3xl text-white md:mb-4 md:text-6xl">
            {heading}
          </h1>
        ...
        {advantages && (
          <ul className="ml-auto hidden h-full flex-col justify-end md:flex lg:pb-[150px]">
            {advantages.map((adv) => (
              <li
                key={adv.id}
                className="mb-6 flex flex-col items-start gap-4 text-white duration-300 hover:scale-110"
              >
                <span>{adv.title}</span>
